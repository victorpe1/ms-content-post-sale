...
import pe.am.gizasi.services.UnidadService;
...
public class UnidadController {
  ...
  @GetMapping
  public ResponseEntity<Response<List<Unidades>>> listarMarcas() {
    try {
      List<Unidades> unidadesList = unidadService.getAllUnidades();
      return ResponseEntity.ok(new Response<>("success", "Lista de marcas obtenida con éxito", unidadesList, HttpStatus.OK.value()));
    } catch (Exception e) {
